function TrackGroup=IterativelyShortestDistance(BoutSpectrum,startIdx)
...
if CC_BoutFore_sub.NumObjects>0
    for SubBoutCnt=1:CC_BoutFore_sub.NumObjects
        ...
        PeakMapSub=PeakMap(:,SubLst);
        TrackGroup_sub=IterativelyShortestDistanceSub(BoutSpectrum_new(:,SubLst),SubLst(1)+startIdx-1,PeakMapSub);
