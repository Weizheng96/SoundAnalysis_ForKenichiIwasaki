function [parameters_new,RMSEachPeak_new,TrackGroup_adjusted_new]=GetParameters_test(TrackGroup_adjusted,SpectrumAlongTime_normalize,RMS)
...
%% F0 freq
F0=TrackGroup_adjusted_new;
Amp=RMSEachPeak_new;
cpath=pwd;
cd("D:\Work\project\Kenichi\SoundAnalysis\F0 collector 2");
previousResult=dir("result_#*.mat");
cnt=length(previousResult)+1;
save("result_#"+cnt+".mat","F0","Amp");
cd(cpath);
